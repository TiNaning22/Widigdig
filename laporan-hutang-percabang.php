        ...
        <div class="card">
          <div class="card-header">
            ...
            <div class="card-tools">
              <a href="toko-add" class="btn btn-primary btn-sm">
            ...
            <div class="table-auto">
              <table id="toko-table" class="table table-bordered table-striped">
                ...
                <?php 
                  ...
                  // Cek apakah ada data
                  if (empty($tokos)) {
                    echo "<tr><td colspan='12' class='text-center'>Tidak ada data toko.</td></tr>";
                  } else {
...
<script>
  $(function () {
    ...
    if (!$.fn.DataTable.isDataTable('#toko-table')) {
      ...
      }).buttons().container().appendTo('#toko-table_wrapper .col-md-6:eq(0)');
    }
  });
</script>
</body>
